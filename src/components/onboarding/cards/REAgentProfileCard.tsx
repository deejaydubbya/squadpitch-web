...
interface Props {
  ...
  onSkip: () => void;
  initialData?: Partial<REAgentProfileData>;
}
...
export function REAgentProfileCard({ onSave, onSkip, initialData }: Props) {
  const [data, setData] = useState<REAgentProfileData>(initialData ?? {});
