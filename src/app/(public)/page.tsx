...
import { authErrorMessage, authHref } from "@/lib/authFlow";
import {
  ArrowRight,
  CalendarDays,
  CheckCircle2,
...
export const metadata: Metadata = {
  title:
    "Squadpitch — Turn any listing into a week of social posts in 90 seconds",
  description:
...
export default function LandingPage({
  ...
  const authMessage = authErrorMessage(searchParams?.auth_error);
  return (
    <div className="min-h-screen bg-white text-gray-900 antialiased">
      ...
      {authMessage && (
        ...
        >
          {authMessage}{" "}
          <a href={LOGIN_HREF} className="font-semibold underline">
      ...
      <div className="mx-auto grid max-w-6xl gap-12 px-4 pb-16 pt-4 sm:px-6 sm:pb-20 sm:pt-6 lg:grid-cols-12 lg:gap-10 lg:pb-24 lg:pt-8">
        <div className="lg:col-span-7">
          ...
          <p className="mt-5 max-w-xl text-lg leading-relaxed text-gray-600">
            Squadpitch helps real estate agents generate ready-to-post campaigns
            from listings, websites, photos, and business data — with captions,
            media, and scheduling built in.
          </p>
          ...
          <p className="mt-5 text-sm text-gray-500">
            Built for agents, teams, and brokerages that need consistent listing
            marketing.
          </p>
        </div>
...
function HeroMock() {
  const posts = [
    {
      tag: "Instagram",
      body: "Just listed in Westfield — 4 bd, light-filled, walk to the park.",
    },
    {
      tag: "Facebook",
      body: "New listing alert: a turn-key family home with the kitchen everyone wants.",
    },
    {
      tag: "LinkedIn",
      body: "Opportunity in Westfield: a rare floor plan in a school district that rarely turns over.",
    },
    { tag: "Story", body: "Open house Sunday 1–3pm. Tap for the tour." },
    {
      tag: "Reel",
      body: "60 seconds inside the home buyers are already DM'ing about.",
    },
  ];
      ...
      <div className="rounded-3xl border border-gray-200 bg-white p-5 shadow-xl shadow-gray-900/5">
        <div className="flex items-center gap-2 rounded-xl border border-gray-200 bg-gray-50 px-3.5 py-3">
          ...
          <span className="truncate text-sm text-gray-500">
            https://yourbrokerage.com/123-elm-st
          </span>
        ...
        <div className="mt-4 space-y-2">
          {posts.map((p, i) => (
            ...
            >
              ...
              <CheckCircle2
                className="mt-1 h-4 w-4 flex-shrink-0 text-[#1DBF60]"
                aria-hidden
              />
            </div>
          ))}
      ...
      <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 sm:py-24">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Paste a listing link, let Squadpitch analyze the property, then
            review a complete campaign with platform-ready captions and selected
            media.
          </p>
        </div>
      ...
      <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 sm:py-24">
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-[#AAF2EB] bg-gradient-to-br from-white to-[#CCFFFA]/40 p-8 shadow-md">
            <div
              className="absolute -top-12 -right-12 h-40 w-40 rounded-full bg-[#2BD974]/10 blur-3xl"
              aria-hidden
            />
            <div className="text-xs font-semibold uppercase tracking-wider text-[#11A64F]">
              After
            </div>
            <h3 className="mt-2 text-2xl font-bold text-gray-900">
              After Squadpitch
            ...
            <ul className="mt-6 space-y-3.5">
              {[
                ...
                >
                  <CheckCircle2
                    className="mt-0.5 h-5 w-5 flex-shrink-0 text-[#1DBF60]"
                    aria-hidden
                  />
                  {line}
                </li>
...
function PricingPreview() {
  const tiers: Array<{
  ...
  }> = [
    {
      ...
      points: [
        "1 workspace",
        "A few campaigns to start",
        "Core post generator",
      ],
      ctaLabel: "Start Free",
      ctaHref: planSignupHref("FREE"),
    },
    {
      name: "Solo",
      price: "$29",
              ...
              <ul className="mt-5 flex-1 space-y-2.5 text-sm text-gray-700">
                {t.points.map((p) => (
                  <li key={p} className="flex items-start gap-2">
                    <CheckCircle2
                      className="mt-0.5 h-4 w-4 flex-shrink-0 text-[#1DBF60]"
                      aria-hidden
                    />
                    {p}
                  </li>
