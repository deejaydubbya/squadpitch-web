    ...
    <div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="mt-10 flex items-center justify-center gap-4">
            <Link
              ...
              className="px-8 py-3 bg-gray-900 text-white rounded-lg text-lg font-medium hover:bg-gray-800"
            >
              Start free
            </Link>
            <Link
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={f.title} className="p-6 bg-white rounded-2xl border border-gray-100">
      ...
      <section className="py-24 text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <Link
            href="/auth/login?screen_hint=signup"
            className="inline-block mt-8 px-8 py-3 bg-gray-900 text-white rounded-lg text-lg font-medium hover:bg-gray-800"
          >
